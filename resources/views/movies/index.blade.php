                                ...
                                <tbody>
                                    ...
                                    @foreach ($movies as $data)
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal3{{$data->id}}">Show
                                                </button>
                                                <div class="modal fade" id="exampleModal3{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-body">
                                                        <video width="465" height="300" controls>
                                                            <source src="{{asset($data->vid)}}" type="video/mp4">
                                                        </video>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Back</button>
