...
<body>
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
    ...
    <!-- ======= category2 Section ======= -->
    <section id="category2" class="category2">
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Price:</strong> <span>Rp.30.000</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Klasifikasi:</strong> <span>Trending</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Category:</strong> <span>Romantice</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Ginatri S.Noer</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Release:</strong> <span>11 Juli 2019</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>01:40:00</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Rate:</strong> <span>4</span></li>
                </ul>
              </div>
          </div>
        </div>
